export default {
	translation: {
		...
		layout: {
			scrollToTop: 'Κάντε κύλιση στην κορυφή',
			internationalizationModal: {
				title: 'προτιμώμενη γλώσσα',
				subtitle: 'Επιλέξτε την προτιμώμενη γλώσσα της επιλογής σας από τη λίστα των γλωσσών παρακάτω',
				empty: {
					title: 'Δεν βρέθηκαν γλώσσες',
					subtitle: 'Δεν βρέθηκαν γλώσσες με το ερώτημα "{{query}}"',
					action: 'Εκκαθάριση αναζήτησης'
				},
				languages: {
					bg: 'Βούλγαρος',
					cs: 'Τσέχος',
			...
			playgroundModal: {
				...
				error: {
					title: 'Απέτυχε η φόρτωση της εφαρμογής',
					subtitle: 'Δυστυχώς, κάτι πήγε στραβά κατά την προσπάθεια φόρτωσης του {{project}}',
					project: 'έργο',
					action: 'Κλείσε'
				},
				cancel: 'Ματαίωση',
